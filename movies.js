firebase.auth().onAuthStateChanged(async function(user){
    ...
    let apiKey = '54ce5b3e7d8077d2525ff43962e9b0a0'
    ...
    let userName = user.displayName
      ...
      <span class="font-bold text-xl"> <h1> It's The Coolest Cinephile: ${userName} </h1></span>
    </div>
      <button class="text-pink-500 underline sign-out">Sign Out ${userName}</button>`
